...
#ifndef NET_TOOLS_QUIC_D0020E_LIBQUIC_QUIC_CLIENT_SESSION_H_
#define NET_TOOLS_QUIC_D0020E_LIBQUIC_QUIC_CLIENT_SESSION_H_

#include <string>

#include "base/basictypes.h"
#include "net/tools/quic/d0020e_libquic/quic_client_session_base.h"
#include "net/quic/quic_crypto_client_stream.h"
#include "net/quic/quic_protocol.h"
#include "net/tools/quic/d0020e_libquic/quic_spdy_client_stream.h"


#include "net/tools/quic/d0020e_libquic/quic_reliable_client_stream.h"
...
class QuicClientSession : public QuicClientSessionBase {
 public:
  ...
  ReliableQuicStream* kurt_CreateOutgoingDynamicStream();
 ...
 protected:
  ...
  virtual ReliableQuicStream* kurt_CreateClientStream();
