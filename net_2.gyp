...

{
  ...
  'targets': [
    ...
    {
      'target_name': 'simple_quic_tools_lib',
      'type': 'static_library',
      'dependencies': [
        '../base/base.gyp:base',
        '../base/third_party/dynamic_annotations/dynamic_annotations.gyp:dynamic_annotations',
      ...
      'sources': [
        'tools/quic/d0020e_libquic/quic_client_base.cc',
        'tools/quic/d0020e_libquic/quic_client_base.h',
        'tools/quic/d0020e_libquic/quic_client_session.cc',
        'tools/quic/d0020e_libquic/quic_client_session.h',
		'tools/quic/d0020e_libquic/quic_client_session_base.cc',
        'tools/quic/d0020e_libquic/quic_client_session_base.h',
        'tools/quic/d0020e_libquic/quic_reliable_client_stream.cc',
        'tools/quic/d0020e_libquic/quic_reliable_client_stream.h',
        ...
        'tools/quic/d0020e_libquic/quic_server_session.cc',
        'tools/quic/d0020e_libquic/quic_server_session.h',
        'tools/quic/d0020e_libquic/quic_simple_client.cc',
        'tools/quic/d0020e_libquic/quic_simple_client.h',
        'tools/quic/quic_simple_per_connection_packet_writer.cc',
        'tools/quic/quic_simple_per_connection_packet_writer.h',
        'tools/quic/d0020e_libquic/quic_simple_server.cc',
        'tools/quic/d0020e_libquic/quic_simple_server.h',
        'tools/quic/quic_simple_server_packet_writer.cc',
        'tools/quic/quic_simple_server_packet_writer.h',
        'tools/quic/d0020e_libquic/quic_spdy_client_stream.cc',
        'tools/quic/d0020e_libquic/quic_spdy_client_stream.h',
        'tools/quic/d0020e_libquic/quic_spdy_server_stream.cc',
        'tools/quic/d0020e_libquic/quic_spdy_server_stream.h',
        'tools/quic/d0020e_libquic/quic_spdy_session.cc',
        'tools/quic/d0020e_libquic/quic_spdy_session.h',
        'tools/quic/d0020e_libquic/quic_spdy_stream.cc',
        'tools/quic/d0020e_libquic/quic_spdy_stream.h',
  ...
  'conditions': [
    ...
    ['OS != "ios" and OS != "android"', {
      'targets': [
        ...
        # p2p test med main-class
        	{'target_name': 'quic_p2p',
	 'type': 'executable',
 	 'dependencies': [
	 '../base/base.gyp:base',
	 '../url/url.gyp:url_lib',
	...
	{'target_name': 'hello_world',
	 ...
	 'sources': [
	 'tools/quic/hello_world.cc',
	 ],
	},
	{'target_name': 'hello_world_server',
	 'type': 'executable',
 	 'dependencies': [
	 '../base/base.gyp:base',
	 '../url/url.gyp:url_lib',
	 ...
	 'sources': [
	 'tools/quic/hello_world_server.cc',
	 ],
	},
		{
		  'target_name': 'hello_emil',
		  'type': 'executable',
	 	  'dependencies': [
		  '../base/base.gyp:base',
		  '../url/url.gyp:url_lib',
		...
		#FÖrsöker bygga i p2p delen.
		{
		  'target_name': 'hello_stream',
		  'type': 'executable',
	 	  'dependencies': [
		  '../base/base.gyp:base',
		  '../url/url.gyp:url_lib',
		  ...
		  'sources': [
		  'quic/hello_stream.cc',
		  ],
		},
		
		{
		  'target_name': 'tester_tester',
		  'type': 'executable',
	 	  'dependencies': [
		  '../base/base.gyp:base',
		  '../url/url.gyp:url_lib',
		  ...
		  'sources': [
		  'tools/quic/tester_tester.cc',
		  ],
		},
		{
          'target_name': 'quic_client_lib',
          'type': 'executable',
          'dependencies': [
            '../base/base.gyp:base',
            '../url/url.gyp:url_lib',
            'net',
            'simple_quic_tools_lib',
          ],
          'sources': [
            'tools/quic/d0020e_libquic/quic_simple_client_bin.cc',
          ],
        },
        {
          'target_name': 'quic_server_lib',
          'type': 'executable',
          'dependencies': [
            '../base/base.gyp:base',
            'net',
          ...
          'sources': [
            'tools/quic/d0020e_libquic/quic_simple_server_bin.cc',
          ],
        },
        {
