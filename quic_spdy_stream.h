...
#ifndef NET_TOOLS_QUIC_D0020E_LIBQUIC_QUIC_SPDY_STREAM_H_
#define NET_TOOLS_QUIC_D0020E_LIBQUIC_QUIC_SPDY_STREAM_H_
...
class NET_EXPORT_PRIVATE QuicSpdyStream : public ReliableQuicStream {
 public:
  ...
  virtual size_t fake_WriteHeaders(bool fin);
